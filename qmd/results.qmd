...
other_effort_all_time <- gridded_time_effort_by_flag |>
...
ggplot()  +
  geom_tile(data = gridded_viirs_detections |>
              dplyr::group_by(lat_bin,
                              lon_bin) |>
              dplyr::summarize(viirs_detections = sum(viirs_detections)) |>
              dplyr::ungroup(),
