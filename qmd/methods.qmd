...
Here we summarize these data (@tbl-sst-summary-stats):

```{r}
#| label: tbl-gfw-summary-stats
#| tbl-cap: Summary statistics for the Global Fishing Watch squid jigger effort dataset.
...
```{r}
#| label: tbl-sst-summary-stats
#| tbl-cap: Summary statistics for the sea surface temperature dataset.

sst_data_aggregated_summary
```

We can also look at a map of SST, using August 2024 as an example (@fig-sst-map).
