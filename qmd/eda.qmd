...
Here we look at a map showing the distance to the nearest 200nm EEZ/high seas boundary for each 0.25x0.25 degree pixel.

```{r}
#| label: fig-distance-to-eez-map
#| fig-cap: Map showing the distance to the nearest EEZ for each 0.25x0.25 degree pixel. EEZ boundaries from Marine Regions V12 are shown in blank.
ggplot()  +
