...
knitr::opts_chunk$set(message = FALSE, warning = FALSE, echo = FALSE, cache=TRUE, dev='png')
...
#| fig-cap: Map of mean August sea surface temperature (SST) under four different climate change scenarios, and three different forecast horizons. Data are for 1x1 degree pixels. The currently proposed analysis scope bounding box is shown as a white outline.
#| fig-height: 10
ggplot() +
  ...
  scale_x_continuous(expand = c(0, 0)) +
  scale_y_continuous(expand = c(0, 0)) +
  facet_wrap(time_period~scenario)
```
